...
function CreateQuote()
{
	global $userbank;
	$quote = array(
		array("www.GameArmy.ru - Мониторинг игровых серверов", "Заходи на GameArmy.ru"),
		array("Модели игроков, оружия и скины для сервера на www.GameArmy.ru!", "Все скины на GameArmy.ru"),
		array("Карты, модели, сервера, мониторинг на www.GameArmy.ru", "На GameArmy.ru Лицензионные сервера, заходи играть к нам!"),
	);
